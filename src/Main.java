...
public class Main {
        ...
        while (loop.equalsIgnoreCase("Yes")) {
            ...
            try {
                ...
                while (myReader.hasNextLine()) {
                    ...
                    } //else specie = String.valueOf(Exotic.valueOf(split[2]));
                    arrayOfAnimal.add(new Animal(split[0], split[1], split[2], split[3], fqpd, split[5], split[6], split[7], split[8], split[9], split[10]));
                    //boolean b = arrayOfAnimal.addAll();
            ...
            try {
                ...
                while (myReader.hasNextLine()) {
                    ...
                    arrayOfFood.add(new Food(split[0], frequency, split[2]));
                }
                myReader.close();
            } catch (FileNotFoundException e) {
                System.out.println("Une erreur est survenue: " + e);
    ...
    public static String YesNo (String message){
        ...
        //choice  = sc.next();
        //newAnimal = sc.nextDouble();
        //        arrayOfAnimal[choice].setanimalname(newAnimal);
